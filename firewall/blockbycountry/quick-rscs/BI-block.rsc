/ip firewall address-list remove [find list="BI-Block"]
...
add address=154.119.0.0/19 list=BI-Block
...
/ip firewall raw
 :if ([print count-only where src-address-list="BI-Block"] = "0") do={ add chain=prerouting action=drop src-address-list=BI-Block comment="Block BI traffic" }
